...
function coursesInClassroom(){
echo -n "Please Input a Classroom Code: "
read className
...
# Example input: SEC
# Example output: See the screenshots in canvas
function availableCoursesInSubject(){
echo -n "Please Input a Subject Code: "
read subjectName


echo ""
echo "Courses in $subjectName :"
cat "$courseFile" | grep "$subjectName" | awk -F';' '{ if ($4 > 0) print $0 }' | \
sed 's/;/ | /g'
echo ""
